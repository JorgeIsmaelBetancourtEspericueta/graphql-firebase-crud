# Tarea: CRUD con GraphQL y Firebase

Este proyecto consiste en la implementación de un CRUD básico de tareas utilizando GraphQL como lenguaje de consulta y Firebase (Firestore) como base de datos. 
